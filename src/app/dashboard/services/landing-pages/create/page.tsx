        ...
        switch (step) {
            ...
            case 1: return (
                <div className="space-y-8">
                    ...
                    <SectionTitle icon={Globe2} title="Datos del Proyecto" color="#00F5FF" />
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="flex gap-3 flex-wrap">
                            {LANGUAGES.map(lang => (
                                <Chip key={lang} label={lang} active={form.language === lang} onClick={() => set('language', lang)} color="#00F5FF" />
                            ))}
                        </div>
                    </div>
                </div>
            ...
            case 3: return (
                <div className="space-y-8">
                    ...
                    <SectionTitle icon={MessageSquare} title="Testimonios" color="#00F5FF" />
                    <div className="space-y-3">
                        ...
                        {form.testimonials.length < 5 && <button type="button" onClick={() => set('testimonials', [...form.testimonials, { name: '', text: '' }])} className="flex items-center gap-2 text-[#00F5FF] text-xs font-bold hover:opacity-80 transition-opacity"><Plus size={14} />Agregar testimonio</button>}
                    </div>
            ...
            case 4: return (
                <div className="space-y-8">
                    ...
                    <SectionTitle icon={Video} title="Videos" color="#00F5FF" />
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            {form.additionalVideos.map((v, i) => (
                                <div key={i} className="flex gap-2">
                                    <input value={v} onChange={e => { const arr = [...form.additionalVideos]; arr[i] = e.target.value; set('additionalVideos', arr) }} placeholder={`Video ${i + 2} URL`} className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white placeholder-white/25 focus:outline-none focus:border-[#00F5FF]/50 text-sm" />
                            ...
                            {form.additionalVideos.length < 2 && <button type="button" onClick={() => set('additionalVideos', [...form.additionalVideos, ''])} className="flex items-center gap-2 text-[#00F5FF] text-xs font-bold hover:opacity-80 transition-opacity"><Plus size={14} />Agregar video</button>}
                        </div>
                    </div>
                </div>
            )
