...
const services = [
  ...
  },
  {
    ...
    description: 'Vende, responde y fideliza clientes las 24 horas sin levantar un dedo. Tu bot trabaja mientras tú duermes, con inteligencia artificial de última generación.',
    icon: MessageCircle,
    from: '#00FF88', to: '#00C2FF',
    features: ['Respuestas automáticas con IA', 'Atención al cliente 24/7', 'Seguimientos automáticos'],
