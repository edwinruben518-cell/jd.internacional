...
export async function GET(req: Request) {
    ...
    if (!code) {
        ...
        const scopes = 'pages_show_list,pages_read_engagement,pages_manage_posts,publish_to_groups,instagram_basic,instagram_content_publish,instagram_manage_insights'
