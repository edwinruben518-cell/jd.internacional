  ...
  try {
    ...
    const rows = await prisma.$queryRaw<Array<{
      ...
      SELECT
        ...
        identity_document, date_of_birth, referral_code,
        sponsor_id::text, avatar_url, is_active, is_admin,
    ...
    // Retorna un objeto compatible con el User de Prisma + campos extra
    return {
      id: row.id,
